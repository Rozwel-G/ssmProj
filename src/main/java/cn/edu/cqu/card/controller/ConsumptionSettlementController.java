...
public class ConsumptionSettlementController {
	...
	/*
	 * @GetMapping("/login") public String login(HttpSession session) { Shop shop =
	 * new Shop(); shop.setShopId(1); User user = new User();
	 * user.setUserPhone("17712345678"); session.setAttribute("user", user);
