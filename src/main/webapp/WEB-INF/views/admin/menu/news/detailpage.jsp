				...
				<div class="head-top">
					...
					<div class=" h_menu4">
						<ul class="memenu skyblue">
							<li><a class="color1" href="/admin/menu/news/update/${requestScope.news.newsId}">修改此新闻</a></li>
							<li><a class="color2" href="/admin/menu/news/delete/${requestScope.news.newsId}?_method=delete" onClick="return confirm('确定删除?');">删除此新闻</a></li>
							<li><a class="color4" href="/admin/menu/news">&ensp;新闻列表&ensp;</a></li>
							<li><a class="color6" href="/admin/menu/news/add">&ensp;发布新闻&ensp;</a></li>
						</ul>
					</div>
