...
<body>
	...
	<div class="staffinfo header">
			<form action="/shop/menu/staff/updateStaffAccount" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
			<!--  staffinfo -->
				<div class="inputdiv">
					<div>
						<span>手机号码：</span><input value="${requestScope.staff.staffPhone }" id="mobile" placeholder = "请输入手机号" name="staffPhone" required />
					</div>
					<div>
				...
				<div class="imgdiv">
					<div style="height:90%"> <img src="/images/${requestScope.staff.staffPic }" id="img0" class="imageauto"> </div>
					<input type="file" id="file" name="file" accept=".jpg,.png" onclick="validate()">
				</div>
